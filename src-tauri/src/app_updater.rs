...
const RELEASES_BASE_URL: &str = "https://sriinnu.github.io/grimoire";
...
mod tests {
    ...
    fn release_channel_endpoints_match_expected_paths() {
        assert_eq!(
            ...
            "https://sriinnu.github.io/grimoire/alpha/latest.json"
        );
        assert_eq!(
            ReleaseChannel::Stable.updater_endpoint().unwrap().as_str(),
            "https://sriinnu.github.io/grimoire/stable/latest.json"
        );
    }
}
