...
pub fn is_local_only_relative_path(path: &Path) -> bool {
...
pub fn is_local_only_export_file(vault_root: &Path, path: &Path) -> bool {
...
pub fn is_local_only_markdown_content(content: &str) -> bool {
