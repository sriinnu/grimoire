...
- The Settings Proof Ledger also shows the live provider proof runner and the redacted report command so the user can distinguish "available to prove" from "provider-proven."
