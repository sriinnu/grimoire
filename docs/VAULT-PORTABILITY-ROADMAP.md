...
- The Settings Proof Ledger also shows a copyable live provider proof runner command and the redacted report path so the user can distinguish "available to prove" from "provider-proven."
