...
- The Settings Proof Ledger also shows copyable no-write dry-run and live provider proof commands with the redacted report path so the user can distinguish "available to prove" from "provider-proven."
