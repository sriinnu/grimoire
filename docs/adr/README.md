...
This folder contains Architecture Decision Records (ADRs) for the Grimoire app.
...
| [0040](0040-custom-views-yml-filter-engine.md) | Custom Views — .grimoire/views/*.yml with YAML filter engine | active |
