...
function verifyBinaryInstallTruth() {
  ...
  assertContains('docs/PUBLIC-READINESS.md', 'Windows MSVC Rust host and Microsoft C++ Build Tools checks')
  ...
  assertContains('docs/PUBLIC-READINESS.md', 'including signed HEAD proof, clean worktree proof, and starter-vault mirror drift')
  assertContains('scripts/audit-public-readiness.mjs', 'compareStarterMirror')
  assertContains('scripts/audit-public-readiness.mjs', 'Starter vault public clone does not match demo-vault-v2')
  ...
  assertContains('scripts/audit-public-readiness.mjs', 'Current branch HEAD does not have a good git signature')
  ...
  assertContains('scripts/audit-public-readiness.mjs', 'Working tree is not clean')
