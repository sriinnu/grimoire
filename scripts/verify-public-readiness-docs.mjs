...
function verifyBinaryInstallTruth() {
  ...
  assertContains('docs/PUBLIC-READINESS.md', 'Windows MSVC Rust host, Microsoft C++ Build Tools, and Linux pkg-config checks')
  assertContains('docs/PUBLIC-READINESS.md', 'xdo, OpenSSL, librsvg, and AppIndicator/Ayatana')
