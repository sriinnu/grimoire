...
RESPONSIBILITIES = [
    ...
    ("responsibility-health-fitness", "Health & Fitness", "area-health",
     ...
     "Staying fit through cycling, gym, and good nutrition. Training for brevets and maintaining energy for work.\n\n## KPIs\n- Resting HR: <55 bpm\n- Cycling: 300+ km/month in season"),
...
TOPICS = [
    ...
    ("topic-indian-startups", "Indian Startup Ecosystem", "The state of tech startups in India — funding, talent, culture, and opportunities."),
    ...
    ("topic-cooking", "Cooking", "Indian cooking, meal prep, and experimenting in the kitchen."),
...
PERSONS = [
    ...
    ("person-anjali-sharma", "Anjali Sharma", "1st 🥇", ["Team"],
    ...
    ("person-abhishek-joshi", "Abhishek Joshi", "3rd 🥉", ["Podcast Guest"],
     "Open source community leader. Episode on sustainability in OSS."),
    ("person-praveen-nair", "Praveen Nair", "3rd 🥉", ["Podcast Guest"],
    ...
    ("person-manoj-subramanian", "Manoj Subramanian", "3rd 🥉", ["Podcast Guest"],
     "Author on software craftsmanship. Episode on code quality and testing."),
    ("person-harish-kumar", "Harish Kumar", "3rd 🥉", ["Podcast Guest"],
     "Node.js contributor. Episode on open-source contributions."),
    ("person-siddharth-venu", "Siddharth Venu", "3rd 🥉", ["Podcast Guest"],
     "CTO, Indian enterprise software. Episode on digital transformation."),
    ("person-maya-fernandez", "Maya Fernandez", "3rd 🥉", ["Podcast Guest"],
     "Tech journalist, Bengaluru. Episode on covering the Indian tech scene."),
    ...
    ("person-revathi-iyer", "Revathi Iyer", "3rd 🥉", ["Podcast Guest"],
     "Startup founder, India. Episode on building a startup in South Asia."),
    ("person-gaurav-bansal", "Gaurav Bansal", "3rd 🥉", ["Podcast Guest"],
...
PERSONAL_CONTACTS = FRIEND_SLUGS + FAMILY_SLUGS + ["person-ananya-rao"]
...
PROJECTS = [
    ...
    ("24q2-hire-editor","Hire Editor (Anjali)","24q2","responsibility-team-management","Done","Hire a part-time editor to raise newsletter quality and free up writing time."),
    ...
    ("24q3-codemotion-talk","Speak at TechConf Hyderabad","24q3","responsibility-content-production","Done","Prepare and deliver a 30-min talk on newsletter growth for technical founders."),
    ...
    ("25q1-grimoire-v1","Grimoire App V1","25q1","responsibility-learning","Done","Ship the first working version of Grimoire with 4-panel layout, inspector, and quick open."),
    ...
    ("25q2-team-retreat","Team Retreat Hyderabad","25q2","responsibility-team-management","Done","First in-person team retreat: 2 days of strategy, workshops, and dinner."),
    ("25q2-grimoire-v2","Grimoire App V2","25q2","responsibility-learning","Done","V2 with BlockNote editor, wiki-links autocomplete, and redesigned theme system."),
    ...
    ("25q3-peak-training","Summer Cycling Peak Training","25q3","responsibility-health-fitness","Done","Peak training block for September brevet. Hit 420km in August."),
    ...
    ("25q4-grimoire-v3","Grimoire App V3","25q4","responsibility-learning","Open","V3: mobile sync, AI note linking, and quick capture from menu bar."),
...
GOALS = [
    ...
    ("2024-complete-two-gran-fondos","Complete Two Gran Fondos","2024","Done","Finish at least two brevets in the 2024 cycling season."),
    ...
    ("2025-ship-grimoire","Ship Grimoire App","2025","Done","Build and use Grimoire v1 as my daily knowledge management tool."),
...
EVERGREENS = [
    ...
    ("italian-startup-ecosystem-observations","Observations on the Indian Startup Ecosystem",["topic-indian-startups"],
     "India produces exceptional technical talent — some of the best engineers in Europe come from Politecnico di Hyderabado and IISc Bengaluru. But the startup ecosystem is immature in specific ways that are interesting to understand.\n\nThe first is risk appetite. Indian professional culture, shaped partly by the importance of stable employment and family obligations, is less tolerant of career risk than US or UK equivalents. This makes recruiting for equity difficult and exit timelines different.\n\nThe second is capital infrastructure. The VC ecosystem is smaller and more conservative than Northern Europe. The best Indian founders often move to Berlin, London, or Amsterdam to raise Series A — not because India is bad, but because the capital isn't there yet."),
...
def build_procedure_map():
    return {
        ...
        "procedure-editorial-review": ("Editorial Review", "responsibility-content-production", "Weekly", "Review Anjali's editing suggestions. Give feedback and approve final drafts."),
        ...
        "procedure-podcast-editing": ("Podcast Editing Review", "responsibility-podcast", "Bi-weekly", "Review Venkatesh's edit of the latest episode. Approve or request changes."),
        ...
        "procedure-race-preparation": ("Race Preparation", "responsibility-health-fitness", "As needed", "1-week taper before a brevet: reduce volume, maintain intensity, focus on nutrition and sleep."),
...
def build_task_templates():
    return [
        ...
        ("Update editorial guidelines for Anjali", "24q2", "Done"),
        ("Research brevet training plans", "24q2", "Done"),
...
def generate_events():
    ...
    while current_date <= end_date and event_count < 650:
        ...
        if weekday == 6:
            if (current_date - date(2024, 1, 7)).days % 14 < 7:
                ...
                write_md("event", f"event-family-call-{day_slug}", {
                    ...
                    "Date": day_slug,
                    "Belongs to": wl(month_slug),
                    "Related to": [wl("person-lakshmi-pendela"), wl("person-ramana-pendela")],
                    "Tags": ["Personal", "Family"],
                }, f"# Family call — {day_slug}\nSunday family call with Elena and parents.")
            event_count += 1

        if weekday == 3 and current_date.day <= 7:
            write_md("event", f"event-1on1-venkatesh-{day_slug}", {
                "aliases": [f"1:1 Venkatesh — {day_slug}"],
                "Is A": "Event",
                "Date": day_slug,
                "Belongs to": wl(month_slug),
                "Related to": [wl("person-venkatesh-rao")],
                "Tags": ["Work"],
            }, f"# 1:1 Venkatesh — {day_slug}\nMonthly 1:1. Operations review, tooling updates, and process improvements.")
            event_count += 1

        if weekday == 6 and current_date.day >= 24:
            write_md("event", f"event-nonna-visit-{day_slug}", {
                "aliases": [f"Nannamma visit — {day_slug}"],
                "Is A": "Event",
                "Date": day_slug,
                "Belongs to": wl(month_slug),
                "Related to": [wl("person-nannamma")],
                "Tags": ["Personal", "Family"],
            }, f"# Nannamma visit — {day_slug}\nMonthly visit to Nannamma in Vijayawada. Lunch with pulihora.")
            event_count += 1
        ...
        if weekday == 4 and random.random() < 0.5:
            friend = random.choice(FRIEND_SLUGS + ["person-ananya-rao"])
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate the large synthetic Grimoire fixture.")
    parser.add_argument(
        "--output",
        type=Path,
