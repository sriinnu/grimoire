...
async function installOnboardingVaultMocks(page: Page, config: MockConfig) {
  await page.addInitScript((mockConfig) => {
    ...
    localStorage.setItem('grimoire:ai-agents-onboarding-dismissed', '1')
    localStorage.setItem('grimoire:claude-code-onboarding-dismissed', '1')
