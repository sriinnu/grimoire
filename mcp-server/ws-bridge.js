#!/usr/bin/env node
/**
 * WebSocket bridge for Grimoire MCP tools.
 *
 * Exposes vault operations over WebSocket so the Grimoire app frontend
 ...
 * is unavailable (e.g. another Grimoire instance owns it).
 */
