...
vi.mock('./grimoireEditorFormattingConfig', () => ({
  filterGrimoireFormattingToolbarItems: (items: ReactNode[]) => items,
...
describe('grimoireEditorFormatting behavior', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('renders toolbar controls, inserts the inline code button, and updates block types', () => {
    ...
    render(<GrimoireFormattingToolbar />)
  ...
  it('uses block alignment when deciding the floating placement', () => {
    ...
    render(<GrimoireFormattingToolbarController />)
  ...
  it('keeps the toolbar open during close grace and clears the timeout on unmount', () => {
    ...
    const { rerender, unmount } = render(<GrimoireFormattingToolbarController />)

    showState.value = false
    rerender(<GrimoireFormattingToolbarController />)
