...
const entries = [
  ...
  makeEntry({ path: '/vault/person/sriinu.md', filename: 'sriinu.md', title: 'Sriinu', isA: 'Person' }),
...
describe('NoteAutocomplete', () => {
  ...
  it('shows note type badge for typed entries', () => {
    const { container } = render(
      <NoteAutocomplete entries={entries} typeEntryMap={typeEntryMap} value="Sriinu" onChange={onChange} onSelect={onSelect} />,
    )
