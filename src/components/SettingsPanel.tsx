  ...
  return (
    <Dialog open={true} onOpenChange={(nextOpen) => { if (!nextOpen) onClose() }}>
      <DialogContent
        ...
        className="settings-panel-shell flex max-h-[86vh] w-[min(940px,calc(100vw-32px))] max-w-none flex-col gap-0 overflow-hidden rounded-lg border p-0 sm:max-w-none"
