...
import {
  ...
  GRIMOIRE_GITHUB_PULL_REQUESTS_URL,
  GRIMOIRE_PRODUCT_BOARD_URL,
...
const SPONSOR_SUPPORT_PATH: ContributionPath = {
  ...
  description: 'Sriinu here 👋 I build Grimoire full-time. It\'s FOSS and always will be — no accounts, no subscriptions, no cloud lock-in.\n\nIf Grimoire helps you think and work better, the best way to support it is to contribute code, report bugs, or share it with someone who\'d find it useful.',
  ctaLabel: 'Star on GitHub',
  label: 'GitHub',
  url: 'https://github.com/sriinnu/grimoire',
  icon: Newspaper,
  tone: 'blue',
}
...
const CONTRIBUTION_PATHS: ContributionPath[] = [
  {
    ...
    label: 'Product Board',
    url: GRIMOIRE_PRODUCT_BOARD_URL,
    icon: Lightbulb,
    tone: 'green',
  },
  {
    ...
    url: GRIMOIRE_GITHUB_DISCUSSIONS_URL,
    icon: MessagesSquare,
    tone: 'purple',
  },
  {
    ...
    url: GRIMOIRE_GITHUB_PULL_REQUESTS_URL,
    icon: GitPullRequest,
    tone: 'yellow',
    secondaryLink: {
      ctaLabel: 'Open Contributing Guide',
      label: 'the contributing guide',
      url: GRIMOIRE_GITHUB_CONTRIBUTING_URL,
    },
  },
]
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <ContributionCard
        ...
        icon={Bug}
        tone="red"
        onAction={() => onOpenLink('GitHub Issues', GRIMOIRE_GITHUB_ISSUES_URL)}
        secondaryAction={(
          <BugReportActions
            copyState={copyState}
