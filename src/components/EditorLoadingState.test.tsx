...
describe('EditorLoadingState', () => {
  it('renders a centered SVG editor loading status', () => {
    ...
    expect(container.querySelector('.editor-loading__thread')).not.toBeNull()
    expect(container.querySelector('.editor-loading__margin-mark')).not.toBeNull()
    expect(container.querySelector('.editor-loading__wand')).toBeNull()
    expect(container.querySelector('.editor-loading__spark')).toBeNull()
  })
})
