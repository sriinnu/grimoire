...
describe('FeedbackDialog', () => {
  ...
  it('opens the expected contribution links without closing the modal', async () => {
    ...
    expect(openExternalUrl).toHaveBeenNthCalledWith(5, GRIMOIRE_GITHUB_CONTRIBUTING_URL)
    expect(openExternalUrl).toHaveBeenNthCalledWith(6, GRIMOIRE_GITHUB_ISSUES_URL)
  ...
  it('shows a fallback message when a contribution link cannot be opened', async () => {
    ...
    expect(screen.getByText(GRIMOIRE_PRODUCT_BOARD_URL)).toBeInTheDocument()
  })
