...
const defaultProps = {
  ...
  defaultVaultPath: '~/Documents/Grimoire',
  onCreateVault: vi.fn(),
...
describe('WelcomeScreen', () => {
  ...
  describe('welcome mode', () => {
    ...
    it('renders the local Grimoire branding icon', () => {
      ...
      const brandIcon = screen.getByAltText('Grimoire icon')
      expect(brandIcon).toHaveAttribute('src', grimoireIcon)
    })
