...
describe('StatusBar', () => {
  ...
  it('displays build number when provided', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/srinivas/Grimoire" vaults={vaults} onSwitchVault={vi.fn()} buildNumber="b223" />)
  ...
  it('shows History badge in status bar', () => {
    render(<StatusBar noteCount={100} vaultPath="/Users/srinivas/Grimoire" vaults={vaults} onSwitchVault={vi.fn()} isGitVault />)
    expect(screen.getByTestId('status-pulse')).toBeInTheDocument()
