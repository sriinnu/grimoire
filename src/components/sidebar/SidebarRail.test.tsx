...
describe('SidebarRail', () => {
  it('keeps collapsed navigation glyphs theme-tonal and stateful', () => {
    ...
    expect(screen.getByTestId('sidebar-rail-journal')).toHaveAttribute('data-sidebar-rail-tone', 'amber')
    expect(screen.getByTestId('sidebar-rail-dreams')).toHaveAttribute('data-sidebar-rail-tone', 'violet')
    expect(screen.getByTestId('sidebar-rail-archive')).toHaveAttribute('data-sidebar-rail-tone', 'neutral')
