          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                color: index === 0 ? '#FFFFFF' : foreground,
              }}
            >
              <span className="h-2.5 w-2.5 rounded-full" style={{ background: index === 0 ? '#FFFFFF' : accent }} />
              <span className="min-w-0 flex-1 truncate">{label}</span>
              <span style={{ color: index === 0 ? 'rgba(255,255,255,0.82)' : muted }}>{count}</span>
            </div>
          ))}
        </div>
