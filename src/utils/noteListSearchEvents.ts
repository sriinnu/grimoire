export const NOTE_LIST_SEARCH_AVAILABILITY_EVENT = 'grimoire:note-list-search-availability'
export const NOTE_LIST_SEARCH_TOGGLE_EVENT = 'grimoire:toggle-note-list-search'
