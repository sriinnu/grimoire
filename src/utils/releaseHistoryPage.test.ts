...
describe('buildReleaseHistoryPage', () => {
  it('renders markdown notes into separate stable and alpha panels with stable selected by default', () => {
    const html = buildReleaseHistoryPage([
      {
        assets: [
          {
            browser_download_url: 'https://example.com/Grimoire.dmg',
            name: 'Grimoire.dmg',
          },
        ],
        body: '## Highlights\n\n- Faster startup\n- Better release notes',
        body_html: '<h2>Highlights</h2><ul><li>Faster startup</li><li>Better release notes</li></ul>',
        html_url: 'https://github.com/sriinnu/grimoire/releases/tag/stable-v2026.4.19',
        name: 'Grimoire Stable 2026.4.19',
        prerelease: false,
      ...
      },
      {
        ...
        html_url: 'https://github.com/sriinnu/grimoire/releases/tag/2026.4.19-alpha.1',
    ...
    expect(html).toContain('Grimoire-setup.exe')
  ...
  it('sorts releases within each channel by published date descending even when the payload order is wrong', () => {
    const html = buildReleaseHistoryPage([
      {
        ...
        name: 'Grimoire Alpha 2026.4.20.9',
        prerelease: true,
      ...
      },
      {
        ...
        name: 'Grimoire Alpha 2026.4.20.12',
        prerelease: true,
      ...
      },
      {
        ...
        name: 'Grimoire Alpha 2026.4.20.10',
        prerelease: true,
    ...
    expect(html.indexOf('Grimoire Alpha 2026.4.20.12')).toBeLessThan(html.indexOf('Grimoire Alpha 2026.4.20.10'))
    expect(html.indexOf('Grimoire Alpha 2026.4.20.10')).toBeLessThan(html.indexOf('Grimoire Alpha 2026.4.20.9'))
  })
