...
describe('relativePathStem', () => {
  it('extracts relative path stem from absolute path and vault path', () => {
    expect(relativePathStem('/Users/srinivas/Vault/note.md', '/Users/srinivas/Vault')).toBe('note')
  })

  it('preserves subdirectory structure', () => {
    expect(relativePathStem('/Users/srinivas/Vault/docs/adr/0031.md', '/Users/srinivas/Vault')).toBe('docs/adr/0031')
  })

  it('falls back to filename stem when vault path does not match', () => {
    expect(relativePathStem('/other/path/note.md', '/Users/srinivas/Vault')).toBe('note')
  })
})
