...
import {
  ...
  Bone, Book, BookBookmark, BookOpen, Bookmark, Books, BowlFood, Bread, Bridge,
  ...
  ShoppingCart, Signature, Smiley, Sneaker, Snowflake, SoccerBall, Sparkle, Stack, StackSimple,
...
export const ICON_OPTIONS: IconEntry[] = [
  ...
  { name: 'star', Icon: GrimoireStarIcon },
