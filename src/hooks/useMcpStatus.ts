...
function connectSuccessToast(result: string): string {
  return result === 'registered'
    ? 'Grimoire external AI tools connected successfully'
    : 'Grimoire external AI tools setup refreshed successfully'
}

function disconnectSuccessToast(result: string): string {
  return result === 'removed'
    ? 'Grimoire external AI tools disconnected successfully'
    : 'Grimoire external AI tools were already disconnected'
}
