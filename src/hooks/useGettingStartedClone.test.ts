...
describe('useGettingStartedClone', () => {
  ...
  it('clones into a child Getting Started folder and reports the canonical path', async () => {
    ...
    mockInvokeFn.mockResolvedValue('/Users/srinivas/Documents/Getting Started')
    ...
    expect(mockInvokeFn).toHaveBeenCalledWith('create_getting_started_vault', {
      targetPath: '/Users/srinivas/Documents/Getting Started',
    })
    expect(onSuccess).toHaveBeenCalledWith('/Users/srinivas/Documents/Getting Started', 'Getting Started')
    expect(onError).not.toHaveBeenCalled()
  })
