...
export function useObjectStoragePortabilityActions({
  ...
  return {
    ...
    s3ProviderPushPreviewArgs: s3ProviderPreviewReports[s3ProviderPreviewKey('push')]?.args,
    s3ProviderPullPreviewArgs: s3ProviderPreviewReports[s3ProviderPreviewKey('pull')]?.args,
    ...
    azureProviderPushPreviewArgs: azureProviderPreviewReports[azureProviderPreviewKey('push')]?.args,
    azureProviderPullPreviewArgs: azureProviderPreviewReports[azureProviderPreviewKey('pull')]?.args,
