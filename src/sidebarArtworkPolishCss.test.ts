...
describe('sidebar artwork polish CSS', () => {
  ...
  it('layers the pouch intake effect after the base artwork polish', () => {
    ...
    expect(css).toContain('.sidebar-artwork__intake-stream')
    expect(css).toContain('.sidebar-artwork__intake-thread')
    expect(css).toContain('.sidebar-artwork__cloud-particle')
    expect(css).toContain('.sidebar-artwork__pouch-shadow')
    expect(css).toContain('.sidebar-artwork__pouch-body')
    expect(css).toContain('.sidebar-artwork__pouch-mouth')
    expect(css).toContain('.sidebar-artwork__pouch-cavity')
    expect(css).toContain('.sidebar-artwork__pouch-depth')
    expect(css).toContain('.sidebar-artwork__pouch-rim-glow')
    expect(css).toContain('.sidebar-artwork__pouch-drawstring')
    expect(css).toContain('.sidebar-artwork__pouch-knot')
    expect(css).toContain('.sidebar-artwork__pouch-throat')
    expect(css).toContain('@media (prefers-reduced-motion: no-preference)')
    expect(css).toContain('@media (prefers-reduced-motion: reduce)')
    ...
    expect(css).toContain('@keyframes sidebar-thread-slip')
    expect(css).not.toContain('infinite')
  })
})
