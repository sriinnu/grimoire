...
const LEARNING_GUIDE_ENTRIES: VaultEntry[] = [
  mockEntry({
    ...
    createdAt: now - 86400,
    fileSize: 4200,
    snippet: 'A shippable in-vault feature showcase for Markdown, journals, dreams, links, properties, search, canvases, audio, agents, privacy, experience profiles, and portability.',
    wordCount: 560,
    relationships: {
      'Belongs to': ['[[25q2]]'],
  ...
  mockEntry({
    ...
    belongsTo: [LEARNING_PROJECT],
    relatedTo: [FEATURE_TOUR, '[[grimoire-markdown-learning]]', '[[grimoire-links-and-backlinks]]', '[[grimoire-calendar-time-loom]]'],
    status: 'Active',
    modifiedAt: now - 120,
    createdAt: now - 86400,
    fileSize: 1650,
  ...
  mockEntry({
    ...
    belongsTo: [LEARNING_PROJECT],
    relatedTo: [FEATURE_TOUR, '[[grimoire-dream-demo-2026-05-31]]', '[[grimoire-calendar-time-loom]]'],
    status: null,
    modifiedAt: now - 240,
    createdAt: now - 86400,
    fileSize: 1300,
    ...
    wordCount: 250,
    relationships: { 'Belongs to': [LEARNING_PROJECT], 'Related to': [FEATURE_TOUR, '[[grimoire-dream-demo-2026-05-31]]', '[[grimoire-calendar-time-loom]]'], 'Type': ['[[journal]]'] },
    outgoingLinks: ['grimoire-learning-project', 'grimoire-feature-tour', 'grimoire-dream-demo-2026-05-31', 'grimoire-calendar-time-loom', 'person-mira-sen'],
  ...
  mockEntry({
    ...
    belongsTo: [LEARNING_PROJECT],
    relatedTo: [FEATURE_TOUR, '[[grimoire-journal-demo-2026-05-31]]', '[[grimoire-calendar-time-loom]]'],
    status: null,
    modifiedAt: now - 300,
    createdAt: now - 86400,
    fileSize: 1200,
    ...
    wordCount: 215,
    relationships: { 'Belongs to': [LEARNING_PROJECT], 'Related to': [FEATURE_TOUR, '[[grimoire-journal-demo-2026-05-31]]', '[[grimoire-calendar-time-loom]]'], 'Type': ['[[dream]]'] },
    outgoingLinks: ['grimoire-journal-demo-2026-05-31', 'grimoire-calendar-time-loom', 'grimoire-feature-tour', 'grimoire-links-and-backlinks'],
    properties: { date: '2026-05-31', symbols: ['library', 'door', 'river'], locality: 'local-first' },
  }),
  mockEntry({
    filename: 'grimoire-calendar-time-loom.md',
    title: 'Calendar and Time Loom Demo',
    isA: 'Note',
    aliases: ['Calendar Time Loom Demo', 'Time Loom Demo'],
    belongsTo: [LEARNING_PROJECT],
    relatedTo: [FEATURE_TOUR, '[[grimoire-journal-demo-2026-05-31]]', '[[grimoire-dream-demo-2026-05-31]]', '[[event-team-sync-2025-01-13]]', '[[grimoire-privacy-and-memory]]'],
    status: 'Active',
    modifiedAt: now - 330,
    createdAt: now - 86400,
    fileSize: 1600,
    snippet: 'A metadata-only calendar substrate showing how Journal, Dream, and Event frontmatter become a private Time Loom graph.',
    wordCount: 260,
    relationships: {
      'Belongs to': [LEARNING_PROJECT],
      'Related to': [FEATURE_TOUR, '[[grimoire-journal-demo-2026-05-31]]', '[[grimoire-dream-demo-2026-05-31]]', '[[event-team-sync-2025-01-13]]'],
      'Type': ['[[note]]'],
    },
    outgoingLinks: ['grimoire-feature-tour', 'grimoire-journal-demo-2026-05-31', 'grimoire-dream-demo-2026-05-31', 'event-team-sync-2025-01-13', 'grimoire-privacy-and-memory'],
    properties: { Priority: 'High', locality: 'local-first' },
  }),
  mockEntry({
    filename: 'event-team-sync-2025-01-13.md',
    title: 'Team sync - 2025-01-13',
    isA: 'Event',
    aliases: ['Team sync - 2025-01-13'],
    belongsTo: ['[[25q1-grimoire-v1]]'],
    relatedTo: ['[[person-mira-sen]]', '[[person-arjun-mehta]]', '[[grimoire-calendar-time-loom]]'],
    status: null,
    modifiedAt: now - 340,
    createdAt: now - 86400,
    fileSize: 560,
    snippet: 'Short checkpoint on V1 priorities that appears as scheduled calendar metadata in Time Loom.',
    wordCount: 70,
    relationships: {
      'Belongs to': ['[[25q1-grimoire-v1]]'],
      'Related to': ['[[person-mira-sen]]', '[[person-arjun-mehta]]', '[[grimoire-calendar-time-loom]]'],
      'Type': ['[[event]]'],
    },
    outgoingLinks: ['25q1-grimoire-v1', 'person-mira-sen', 'person-arjun-mehta', 'grimoire-calendar-time-loom'],
    properties: { date: '2025-01-13' },
  }),
  mockEntry({
  ...
  mockEntry({
    ...
    isA: 'Note',
    aliases: ['Settings and Themes', 'Experience Profiles and Settings'],
    belongsTo: [LEARNING_PROJECT],
    ...
    createdAt: now - 86400,
    fileSize: 1100,
    snippet: 'Experience profiles, color mode, typography, provider settings, API key boundaries, privacy, workflow, sync, and appearance settings.',
    wordCount: 175,
    relationships: { 'Belongs to': [LEARNING_PROJECT], 'Related to': [FEATURE_TOUR], 'Type': ['[[note]]'] },
