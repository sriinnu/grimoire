...
const EN_TRANSLATIONS = {
  ...
  'command.openSettings.keywords': 'preferences config appearance theme themes 2050 aether ion moss lumen',
  ...
  'settings.themePreset.classic': 'Classic',
  'settings.themePreset.classicDescription': 'Clean, bright, familiar.',
  'settings.themePreset.manuscript': 'Manuscript',
  'settings.themePreset.manuscriptDescription': 'Ink-teal sidebar, parchment page, gold ink.',
  'settings.themePreset.graphite': 'Graphite',
  'settings.themePreset.graphiteDescription': 'Calm contrast, less glare.',
  'settings.themePreset.studio': 'Studio',
  'settings.themePreset.studioDescription': 'Clean canvas, cinematic accents.',
  'settings.themePreset.folio': 'Folio',
  'settings.themePreset.folioDescription': 'Editorial page, quiet color.',
  'settings.themePreset.nocturne': 'Nocturne',
  'settings.themePreset.nocturneDescription': 'Dark desk, luminous links.',
  'settings.themePreset.aether': '2050+',
  'settings.themePreset.aetherDescription': 'Carbon glass, living signal, local-first edge.',
  'settings.themePreset.ion': 'Ion',
  'settings.themePreset.ionDescription': 'Fast command energy, crisp contrast, coral signal.',
  'settings.themePreset.moss': 'Moss',
  'settings.themePreset.mossDescription': 'Field-notes calm, copper warmth, deep green focus.',
  'settings.themePreset.lumen': 'Lumen',
  'settings.themePreset.lumenDescription': 'Quiet daylight, coral action, clear cyan support.',
  'settings.themePreset.lotus': 'Lotus',
  'settings.themePreset.lotusDescription': 'Personal, soft, warm without going beige.',
  'settings.themePreset.ember': 'Ember',
  'settings.themePreset.emberDescription': 'Dark, intimate, gold-lit focus.',
...
const ZH_HANS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'settings.themePreset.classic': 'Classic',
  'settings.themePreset.classicDescription': '干净、明亮、熟悉。',
  'settings.themePreset.manuscript': 'Manuscript',
  'settings.themePreset.manuscriptDescription': '墨青侧栏、羊皮纸页面与金色墨迹。',
  'settings.themePreset.graphite': 'Graphite',
  'settings.themePreset.graphiteDescription': '柔和对比，减少眩光。',
  'settings.themePreset.studio': 'Studio',
  'settings.themePreset.studioDescription': '干净画布，电影感强调色。',
  'settings.themePreset.folio': 'Folio',
  'settings.themePreset.folioDescription': '编辑式页面，安静色彩。',
  'settings.themePreset.nocturne': 'Nocturne',
  'settings.themePreset.nocturneDescription': '深色书桌，明亮链接。',
  'settings.themePreset.aether': '2050+',
  'settings.themePreset.aetherDescription': '碳色玻璃、灵动信号、本地优先锋芒。',
  'settings.themePreset.ion': 'Ion',
  'settings.themePreset.ionDescription': '快速命令感、清晰对比与珊瑚色信号。',
  'settings.themePreset.moss': 'Moss',
  'settings.themePreset.mossDescription': '田野笔记般安静，铜色温度，深绿专注。',
  'settings.themePreset.lumen': 'Lumen',
  'settings.themePreset.lumenDescription': '安静日光、珊瑚色动作与清透青色辅助。',
  'settings.themePreset.lotus': 'Lotus',
  'settings.themePreset.lotusDescription': '柔和、私人、温暖但不米色。',
  'settings.themePreset.ember': 'Ember',
  'settings.themePreset.emberDescription': '深色、亲密、金色专注感。',
