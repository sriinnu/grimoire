...
const EN_TRANSLATIONS = {
  ...
  'settings.aiAgents.routeTruth': 'Route truth: Grimoire {providerRoute}; it {modelRoute}.',
  'settings.aiAgents.routeProviderCli': 'does not pass --provider and lets the local Chitragupta CLI choose',
  'settings.aiAgents.routeProviderOverride': 'passes --provider {provider}',
  'settings.aiAgents.routeModelCli': 'does not pass --model',
  'settings.aiAgents.routeModelOverride': 'passes --model {model}',
