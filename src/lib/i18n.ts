...
const EN_TRANSLATIONS = {
  ...
  'settings.sync.description': 'Configure local Git behavior, AutoGit, and the update feed preference. App updates only install from verified published feeds.',
  ...
  'settings.sync.runway.releaseDetail': 'Preference only; update checks verify published feeds before offering an install.',
  ...
  'settings.releaseTruth.title': 'Release and platform truth',
  'settings.releaseTruth.description': 'These labels describe what Grimoire can claim on this machine without pretending public installers or updater feeds already exist.',
  'settings.releaseTruth.platformLabel': 'Current platform',
  'settings.releaseTruth.platformDetail': 'Settings copy and native controls are scoped to {platform}.',
  'settings.releaseTruth.sourceLabel': 'Source mode',
  'settings.releaseTruth.sourceValue': 'Source app',
  'settings.releaseTruth.sourceMac': 'macOS source development and local native launch have current local proof.',
  'settings.releaseTruth.sourceWindows': 'Windows source builds are guarded, but fresh Windows launch proof is still required before public support.',
  'settings.releaseTruth.sourceLinux': 'Linux source checks are guarded, but fresh Linux launch proof is still required before public support.',
  'settings.releaseTruth.sourceUnknown': 'Run the source doctor before treating this OS as supported.',
  'settings.releaseTruth.packagedLabel': 'Packaged updates',
  'settings.releaseTruth.packagedDetail': 'Stable/Alpha only selects a feed preference; Grimoire offers updates only when a signed feed is actually published.',
  ...
  'settings.appearance.description': 'Choose the full Grimoire experience: shell, density, motion, graph, canvas, and writing texture.',
  ...
  'settings.theme.label': 'Color mode',
  'settings.theme.light': 'Light',
  'settings.theme.dark': 'Dark',
  'settings.themePreset.label': 'Experience profile',
  'settings.themePreset.group.signature': 'Notebook identities',
  'settings.themePreset.group.paper': 'Paper studios',
  'settings.themePreset.group.specialist': 'Graph & Code labs',
  'settings.themePreset.constellation': 'Notebook Map',
  'settings.themePreset.constellationDescription': 'Dark map for seeing how your notes connect. Private notes stay withheld by default.',
  'settings.themePreset.daylightNotebook': 'Daylight Notebook',
  'settings.themePreset.daylightNotebookDescription': 'Bright notebook panels, clean ink, graphite rails, and blue-ink actions.',
  'settings.themePreset.morningNotebook': 'Morning Notebook',
  'settings.themePreset.morningNotebookDescription': 'A bright personal notebook: white paper, graphite ink, blue mark, restrained blue-ink actions.',
  'settings.themePreset.livingArchive': 'Graphite Archive',
  'settings.themePreset.livingArchiveDescription': 'Cool paper, graphite rail, muted blue marks, and clean notebook actions.',
  'settings.themePreset.nocturne': 'Night Notebook',
  'settings.themePreset.nocturneDescription': 'Dark desk, graphite panels, steel actions, and quiet notebook motion.',
  'settings.themePreset.codeNotebook': 'Code Notebook',
  'settings.themePreset.codeNotebookDescription': 'Plain dark notebook for code notes, logs, and terminal snippets.',
  ...
  'settings.native.windowGroup': 'Window & menu bar',
  ...
  'settings.aiAgents.providerKeysSet': 'Set key…',
  ...
  'settings.aiAgents.chitraguptaSocketTitle': 'Chitragupta daemon',
  'settings.aiAgents.chitraguptaSocketDescription': 'When the local daemon is running and a token is saved, Grimoire chats through it directly and threads sessions per note. Without it, chat falls back to the Chitragupta CLI.',
  'settings.aiAgents.chitraguptaSocketTokenLabel': 'Chitragupta daemon token',
  'settings.aiAgents.chitraguptaSocketConnect': 'Connect automatically',
  'settings.aiAgents.chitraguptaSocketConnecting': 'Connecting...',
  'settings.aiAgents.chitraguptaSocketConnectHint': 'Rotates a Grimoire key via the local Chitragupta CLI and stores it in {secureStore}.',
  'settings.aiAgents.chitraguptaSocketWaiting': 'Key created — waiting for the Chitragupta daemon to refresh. Restart or refresh the daemon, then check the connection.',
  'settings.aiAgents.chitraguptaSocketCheck': 'Check connection',
  ...
  'settings.privacy.description': 'Grimoire runs entirely on your machine. There are no accounts, no servers, and no telemetry — nothing about your notebook leaves this device.',
  'settings.privacy.localOnly': 'Everything stays local',
  'settings.privacy.localOnlyDescription': 'Your notes, journals, and dreams live as plain files on this device. Grimoire never phones home, and we never see your words. The only thing that can leave is what you explicitly send — like cloud transcription, below, which is off until you turn it on.',
  ...
  'settings.privacy.transcriptionGroup': 'Transcription',
  ...
  'noteList.empty.noArchived': 'No archived pages',
  'noteList.empty.noMatching': 'No matching pages',
  'noteList.empty.allOrganized': 'All pages are organized',
  'noteList.empty.noNotes': 'No pages found',
