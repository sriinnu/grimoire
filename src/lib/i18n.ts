...
const EN_TRANSLATIONS = {
  ...
  'settings.themePreset.retro': 'Retro',
  'settings.themePreset.retroDescription': 'Amber screen, green desk, punchy ink.',
  'settings.themePreset.aurora': 'Aurora',
  'settings.themePreset.auroraDescription': 'Vivid, cinematic, a little wow.',
  'settings.themePreset.future': '2026+',
  'settings.themePreset.futureDescription': 'Glass-clean surfaces, signal accents.',
...
const ZH_HANS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'settings.themePreset.retro': 'Retro',
  'settings.themePreset.retroDescription': '琥珀屏幕、绿色桌面、醒目的墨色。',
  'settings.themePreset.aurora': 'Aurora',
  'settings.themePreset.auroraDescription': '鲜明、电影感，带一点惊艳。',
  'settings.themePreset.future': '2026+',
  'settings.themePreset.futureDescription': '清透界面，信号感强调色。',
  'settings.themePreset.lotus': 'Lotus',
