...
const EN_TRANSLATIONS = {
  ...
  'command.openSettings.keywords': 'preferences config appearance theme themes constellation living archive research cockpit nocturne manuscript retro terminal',
  ...
  'settings.themePreset.researchCockpit': 'Research Cockpit',
  'settings.themePreset.researchCockpitDescription': 'Dense signal, agent rails, execution-focused workbench.',
  'settings.themePreset.manuscript': 'Manuscript',
  'settings.themePreset.manuscriptDescription': 'Ink-teal sidebar, parchment page, gold marginalia.',
...
const ZH_HANS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'command.openSettings.keywords': '设置 偏好 配置 外观 主题 constellation living archive research cockpit nocturne manuscript retro terminal',
  ...
  'settings.themePreset.researchCockpit': 'Research Cockpit',
  'settings.themePreset.researchCockpitDescription': '高密度信号、代理侧栏、以执行为中心的工作台。',
  'settings.themePreset.manuscript': 'Manuscript',
  'settings.themePreset.manuscriptDescription': '墨青侧栏、羊皮纸页面与金色旁注。',
  'settings.themePreset.nocturne': 'Nocturne',
