...
const EN_TRANSLATIONS = {
  ...
  'settings.appearance.description': 'Choose the app color mode used for Grimoire chrome, editor surfaces, menus, and dialogs.',
...
const ZH_HANS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'settings.appearance.description': '选择 Grimoire 界面、编辑器、菜单和对话框使用的颜色模式。',
