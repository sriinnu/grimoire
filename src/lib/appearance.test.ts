...
describe('appearance', () => {
  ...
  it('applies appearance attributes to the root document', () => {
    ...
    expect(document.documentElement).toHaveAttribute('data-theme-metadata-fields', 'type status owner priority modified')
    expect(document.documentElement).toHaveAttribute('data-theme-metadata-strip', 'quiet')
