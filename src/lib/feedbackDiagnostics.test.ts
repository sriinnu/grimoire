...
describe('feedbackDiagnostics', () => {
  ...
  it('sanitizes recent warnings and errors before building the bundle', () => {
    ...
    console.error('Load failed for /Users/srinivas/Grimoire/private.md with token ghp_super-secret-token')
    ...
    expect(bundle).toContain('Grimoire sanitized diagnostics')
    ...
    expect(bundle).not.toContain('/Users/srinivas/Grimoire/private.md')
